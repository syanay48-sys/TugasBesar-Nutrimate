...
public class LaporanEntity {
    ...
    public void setLaporanId(int id) {
        this.laporanId = id;
    }
    ...
    public double getTotalKaloriMasuk() {
        return totalKaloriMasuk;
    }

    public void setTotalKaloriMasuk(double kalori) {
        this.totalKaloriMasuk = kalori;
    }
    ...
    public void setTargetKalori(double target) {
        this.targetKalori = target;
    }

    public double getSisaKalori() {
        return sisaKalori;
    }

    public void setSisaKalori(double sisa) {
        this.sisaKalori = sisa;
    }

    public String getStatusDiet() {
        return statusDiet;
    }

    public void setStatusDiet(String status) {
        this.statusDiet = status;
    }
