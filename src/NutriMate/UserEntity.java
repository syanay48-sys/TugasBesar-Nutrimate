...
public class UserEntity {
    ...
    private double beratBadan;   // kg
    private double tinggiBadan;  // cm
    private String aktivitas;    // Ringan / Sedang / Berat
    private String targetDiet;   // Menurunkan / Menaikkan / Menjaga
    private double targetKalori; // kkal/hari
    ...
    public void setBeratBadan(double bb)         { this.beratBadan = bb; }
    public double getTinggiBadan()               { return tinggiBadan; }
    public void setTinggiBadan(double tb)        { this.tinggiBadan = tb; }
    public String getAktivitas()                 { return aktivitas; }
    public void setAktivitas(String aktivitas)   { this.aktivitas = aktivitas; }
    public String getTargetDiet()                { return targetDiet; }
    public void setTargetDiet(String targetDiet) { this.targetDiet = targetDiet; }
    public double getTargetKalori()              { return targetKalori; }
    public void setTargetKalori(double tk)       { this.targetKalori = tk; }
